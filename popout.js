window.addEventListener('load', () => {
	...
	newTodoForm.addEventListener('submit', e => {
		...
		const todo = {
			...
			timeset: e.target.elements.settime1.value,
			done: false,
...
function DisplayTodos () {
	...
	todos.forEach(todo => {
		...
		label.appendChild(settime);
		actions1.appendChild(settime);
